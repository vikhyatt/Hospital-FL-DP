...
class ClientUpdate(object):
    ...
    def train(self, model):
        ...
        early_stopping = EarlyStopping(patience=10, verbose=True, path =  "FL_DP1_models/fl_client%s_resnet_weights.pt"%self.client)
        ...
        model.load_state_dict(torch.load("FL_DP1_models/fl_client%s_resnet_weights.pt"%self.client))
...
#     print("Total time taken to Train: {}".format(end-start))
    ...
    torch.save(model.state_dict(), 'FL_DP1_models/fl_resnet_localdp_0.5_weights.pt')
    return model
...
# resnet_trained.load_state_dict(torch.load("FL_DP1_models/fl_resnet_localdp_0.5_weights.pt"))
